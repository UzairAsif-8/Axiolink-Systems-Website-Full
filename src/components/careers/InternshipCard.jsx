...
import { getInternshipIcon } from "./internshipIcons";
    ...
    >
      <div className="h-full flex flex-col rounded-2xl bg-white border border-neutral-200/80 p-6 shadow-sm hover:shadow-xl hover:shadow-primary-500/10 hover:border-primary-200 transition-all duration-300">
        <div className="flex items-start justify-between mb-4">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center text-white shadow-lg shadow-primary-500/25 group-hover:scale-105 transition-transform">
        ...
        <div className="flex gap-2 mt-auto">
          <Button
            ...
            onClick={() => navigate(`/careers/${internship.slug}`)}
          >
            View Details
          ...
          <Button
            size="sm"
            variant="secondary"
            onClick={() => navigate(`/careers/${internship.slug}/apply`)}
          >
            Apply
          </Button>
        </div>
